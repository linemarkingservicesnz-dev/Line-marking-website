...
import heroImage from "../assets/images/epoxy-flooring-page.webp";
import heroImageWebp from "../assets/images/epoxy-flooring-page.webp";
    ...
    <div data-testid="page-epoxy-flooring">
      <div className="relative w-full h-[300px] md:h-[380px] overflow-hidden">
        <picture>
          ...
          <img src={heroImage} alt="Epoxy flooring in NZ workshop" className="w-full h-full object-cover" width={1408} height={768} fetchpriority="high" data-testid="img-hero" />
        </picture>
