...
import heroImage from "../assets/images/line-removal.webp";
import heroImageWebp from "../assets/images/line-removal.webp";
    ...
    <div data-testid="page-line-removals">
      <div className="relative w-full h-[300px] md:h-[380px] overflow-hidden">
        <picture>
          ...
          <img src={heroImage} alt="Line removal and concrete grinding" className="w-full h-full object-cover" width={1408} height={768} fetchpriority="high" data-testid="img-hero" />
        </picture>
