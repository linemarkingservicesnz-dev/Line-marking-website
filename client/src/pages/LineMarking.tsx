    ...
    <div data-testid="page-line-marking">
      <div className="relative w-full h-[300px] md:h-[380px] overflow-hidden">
        <picture>
          ...
          <img src={heroImage} alt="Car park line marking in Christchurch" className="w-full h-full object-cover" width={1408} height={768} fetchpriority="high" data-testid="img-hero" />
        </picture>
