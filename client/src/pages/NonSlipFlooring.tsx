...
import heroImage from "../assets/images/non-slip-flooring.webp";
import heroImageWebp from "../assets/images/non-slip-flooring.webp";
    ...
    <div data-testid="page-non-slip-flooring">
      <div className="relative w-full h-[300px] md:h-[380px] overflow-hidden">
        <picture>
          ...
          <img src={heroImage} alt="Non-slip textured floor coating" className="w-full h-full object-cover" width={1408} height={768} fetchpriority="high" data-testid="img-hero" />
        </picture>
