    ...
    <div data-testid="page-pedestrian-walkways">
      <div className="relative w-full h-[300px] md:h-[380px] overflow-hidden">
        <picture>
          ...
          <img src={heroImage} alt="Pedestrian walkway markings in warehouse" className="w-full h-full object-cover" width={1408} height={768} fetchpriority="high" data-testid="img-hero" />
        </picture>
